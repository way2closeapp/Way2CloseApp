...
// //var db = mongoose.createConnection('mongodb://test1:Password@ds151279.mlab.com:51279/property');
// var conn = new mongoose();
// db = conn.getDB("Tasks");
// exports.sched = schedule.scheduleJob(rule, function(){
...
//                     /*DEBUG*/var email="patrickgourdet79@gmail.com";
//                     var passage = "<!DOCTYPE html><html lang='en-US'><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8' /></head>" +
//                         "<body><h3>Hello!</h3>" +
